...
/*   Updated: 2024/07/16 02:34:18 by hoysong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "my_fdf.h"
...
static void	setup_mlx(t_mlx_ptrs *mlx_ptrs)
{
	...
	/* === gen win ptr === */
	mlx_ptrs->win_ptr = mlx_new_window(mlx_ptrs->init_ptr, 1920, 1010, "window_1");
...
int	main(int argc, char *argv[])
{
	...
	pixel_test(mlx_ptrs.img_data, mlx_ptrs.prs_data);
